...
def start_server():
    ...
    server_command = "uvicorn oai_nmdc_plugin.main:app --host 0.0.0.0 --port 3434"
...
#dev = "uvicorn oai_nmdc_plugin.main:app --host 0.0.0.0 --port 3333 --reload"
#dev = "python:uvicorn.main.run(app='oai_nmdc_plugin.main:app', host='0.0.0.0', port=3333, reload=True)"
